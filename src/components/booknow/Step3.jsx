...
const Step3 = () => {
    ...
    return (
        ...
        <div>
            <h1 className='text-[20px] font-light'>{translation.steam_section.heading}</h1>
            ...
            <h1 className='text-[20px] font-light'>{translation.oud_section.heading}</h1>
            ...
            </div>
            {
                profile.Incense &&
                <div >
                    <h1 className='text-[20px] font-light'>{translation.oud_section.OudObject.Choose_oud}</h1>
